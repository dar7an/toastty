...
extension Notification.Name {
    static let fullscreenDidEnter = Notification.Name("com.dar7an.toastty.fullscreenDidEnter")
    static let fullscreenDidExit = Notification.Name("com.dar7an.toastty.fullscreenDidExit")
}
